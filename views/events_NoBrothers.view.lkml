...
view: events_NoBrothers {
  sql_table_name: `evident-catcher-381918.analytics_330690431.events_*` ;;
  ...
  dimension: event_month_int {
    ...
    sql: EXTRACT(MONTH FROM PARSE_DATE("%Y%m%d", ${TABLE}.event_date));;
...
view: events_NoBrothers__items {
  ...
  dimension: events_20230731__items {
    type: string
    hidden: yes
    sql: events_20230731__items ;;
  }
...
view: events_NoBrothers__event_params {

  dimension: events_20230731__event_params {
    type: string
    hidden: yes
    sql: events_20230731__event_params ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: events_NoBrothers__user_properties {

  dimension: events_20230731__user_properties {
    type: string
    hidden: yes
    sql: events_20230731__user_properties ;;
  }
  dimension: key {
    type: string
    sql: key ;;
