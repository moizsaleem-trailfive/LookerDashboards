...
view: events_Salland {
  ...
  dimension: Page_location{
    ...
    sql: (SELECT value.string_value
             ...
             WHERE event_name="Sollicitatie_definitief" AND key = 'page_referrer' AND REGEXP_EXTRACT(value.string_value, 'utm_id=([^&]+)') is not null);;
  }
...
view: events_Salland__items {
  ...
  dimension: events_Salland__items {
    type: string
    hidden: yes
    sql: events_20230921__items ;;
  }
...
view: events_Salland__event_params {

  dimension: events_20230921__event_params {
    type: string
    hidden: yes
    sql: events_20230921__event_params ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: events_Salland__user_properties {

  dimension: events_20230921__user_properties {
    type: string
    hidden: yes
    sql: events_20230921__user_properties ;;
  }
  dimension: key {
    type: string
    sql: key ;;
