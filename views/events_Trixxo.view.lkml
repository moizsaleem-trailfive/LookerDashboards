...
view: events_Trixxo {
  sql_table_name: `evident-catcher-381918.analytics_338697027.events_*` ;;
...
view: events_Trixxo__items {
  ...
  dimension: events_20230919__items {
    type: string
    hidden: yes
    sql: events_20230919__items ;;
  }
...
view: events_Trixxo__event_params {

  dimension: events_20230919__event_params {
    type: string
    hidden: yes
    sql: events_20230919__event_params ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: events_Trixxo__user_properties {

  dimension: events_20230919__user_properties {
    type: string
    hidden: yes
    sql: events_20230919__user_properties ;;
  }
  dimension: key {
    type: string
    sql: key ;;
