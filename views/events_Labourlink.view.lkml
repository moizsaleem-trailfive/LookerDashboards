...
view: events_LabourLink {
  sql_table_name: `evident-catcher-381918.analytics_331941345.events_*` ;;
...
view: events_LabourLink__items {
  ...
  dimension: events_intraday_20230921__items {
    type: string
    hidden: yes
    sql: events_intraday_20230921__items ;;
  }
...
view: events_LabourLink__event_params {

  dimension: events_intraday_20230921__event_params {
    type: string
    hidden: yes
    sql: events_intraday_20230921__event_params ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: events_LabourLink__user_properties {

  dimension: events_intraday_20230921__user_properties {
    type: string
    hidden: yes
    sql: events_intraday_20230921__user_properties ;;
  }
  dimension: key {
    type: string
    sql: key ;;
