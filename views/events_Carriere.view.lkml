view: events_Carriere {
  sql_table_name: `evident-catcher-381918.analytics_318123502.events_*` ;;
...
view: events_Carriere__items {
  ...
  dimension: events_20230914__items {
    type: string
    hidden: yes
    sql: events_20230914__items ;;
  }
...
view: events_Carriere__event_params {

  dimension: events_20230914__event_params {
    type: string
    hidden: yes
    sql: events_20230914__event_params ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: events_Carriere__user_properties {

  dimension: events_20230914__user_properties {
    type: string
    hidden: yes
    sql: events_20230914__user_properties ;;
  }
  dimension: key {
    type: string
    sql: key ;;
